export const skingardenText = {
  ...
  This body of work is positioned against gatekeeping that excludes bodies that don't fall under the heterocentric, patriarchal lens of the current canon (fat bodies, trans bodies, femme bodies, post-human bodies, trans-human bodies, melanated bodies). Reconsider Flesh carves out a space for just some of the bodies excluded when multitudes are reduced to a monolith. 
  `,
  walkinsWelcome: `
  Walk-ins Welcome is a digital tattoo showroom of tattoos that incorporate digital mediums (e.g. 3D modeling, virtual reality, digital painting). This space features artists across time zones: from Moscow, Shanghai, Seoul, and the Bay Area. The soundscape is assembled from residual sounds of a tattoo in session.

  Advances in image-rendering have become interwoven into the process of tattooing, and archived onto skin. More and more, this analog art form has seen a shift towards the digital and the experimental. Walk-ins Welcome is a showcase of artists who have embraced this shift in their practice. 

  This sculpture garden features flash available for your skin, etched onto fleshy structures sculpted by Nusi Quero in collaboration with Alex Shilt. The space is encased in skeletal walls sculpted by Lady Bambs. The soundscape is a remote collaboration between Miss Sammie and Nusi Quero, woven entirely from the sounds of tattooing. 
  `,
  curators: `
