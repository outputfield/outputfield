...
const Link: React.FC<{ className?: string }> = ({ className, children }) => {
  const color = '#0404FF';
  return (
    <a className={classnames("text-lg font-semibold filter drop-shadow-2xl", className)} style={{ color: 'rgb(4, 4, 255)', textShadow: `0 0 2px rgba(4, 4, 255, 0.4)` }}>
      {children}
    </a>
  );
};
      ...
      <div className="container">
        <div className="grid grid-cols-rsvp gap-10">
          ...
          <Day
            ...
            description={
              <div>
                Get acquainted with the Skin Garden lobby. This will be our
                living room for the next three days. Some of our artist friends
                will be streaming some mixes over Zoom. Zoom code will be in the
                New Art City space
              </div>
            }
          />
          <Day
            ...
            description={
              <div>
                Tune in to hear the approach behind the room, Bodies Unhinge.
                The artists behind the space discuss the process behind
                articulating queer affect, through breath, movement, voice.
