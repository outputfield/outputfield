      ...
      <div className={styles.grid}>
        ...
        <div className={styles.detailgrid}>
          ...
          <div className={styles.detaildescription}>
            ...
            <br/>
            From Anne Anlin Cheng’s recent call for a theory of the “yellow woman” to Grace Lee Boggs’ echoing insistence that we can only change society if we take responsibility for that change, we’ll be sharing voices that express the diversity of what it looks like to be political. Excavate the covert, subvert the inert. Jex Wang (Easter Margins) will conclude with an hour of ambient sound. Tracklist can be found <a href={pageData.tracklist}>here</a>.
          </div>
